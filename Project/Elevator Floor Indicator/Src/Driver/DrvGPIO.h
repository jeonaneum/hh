...
typedef enum
{
    ...
    E_FUNC_UART0,   E_FUNC_UART0_RX_TX, E_FUNC_UART0_RTS,  E_FUNC_UART0_RTS_CTS,
    E_FUNC_UART1,   E_FUNC_UART1_RX_TX, E_FUNC_UART1_RTS,  E_FUNC_UART1_RTS_CTS,    E_FUNC_UART2,
...
#define IMD15_LEV							(1<<15)
#define IMD15_EDG							~(1<<15)

#define IMD14_LEV							(1<<14)
#define IMD14_EDG							~(1<<14)

#define IMD13_LEV							(1<<13)
#define IMD13_EDG							~(1<<13)

#define IMD12_LEV							(1<<12)
#define IMD12_EDG							~(1<<12)

#define IMD11_LEV							(1<<11)
#define IMD11_EDG							~(1<<11)

#define IMD10_LEV							(1<<10)
#define IMD10_EDG							~(1<<10)
